 ...
 */
@Entity
@Table(name = UserCardV01.TABLE_NAME, uniqueConstraints = {
        @UniqueConstraint(columnNames = { "card_number" },
                name = "uc_user_card_1"),
        @UniqueConstraint(columnNames = { "user_id", "index_number" },
                name = "uc_user_card_2") }, indexes = { @Index(
        name = "ix_user_card_1", columnList = "user_id, card_number") })
